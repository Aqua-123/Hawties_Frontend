        ...
        <ul>
          <li><button>File</button>
            <div className='dropdown'>
              <ul>
                <li><button>New SpreadSheet</button></li>
                <li><button>Open</button></li>
                <li><button>Import</button>
                  <div className='dropdown3'>
                    <ul>
                      <li><button>CSV</button></li>
                      <li><button>Excel (.xlsx)</button></li>
                      <li><button>JSON</button></li>
                      <li><button>Parquet</button></li>
                    </ul>
                  </div>
                </li>
                <li><button>Share</button></li>
                <li><button>Download</button>
                  <div className='dropdown3'>
                    <ul>
                      <li><button>Microsoft Excel (.xlsx)</button></li>
                      <li><button>PDF (.pdf)</button></li>
                      <li><button>Comma Separated Value (.csv)</button></li>
                    </ul>
                  </div></li>
          ...
          <li><button>Insert</button>
            <div className='dropdown'>
              <ul>
                <li><button>Cells</button>
                  <div className='dropdown1'>
                    <ul>
                      <li><button>Insert cell and shift Right</button></li>
                      <li><button>Insert cell and shift Down</button></li>
                    </ul>
                  </div></li>
                <li><button>Rows</button>
                  <div className='dropdown1'>
                    <ul>
                      <li><button>Insert one row above</button></li>
                      <li><button>Insert one row below</button></li>
                    </ul>
                  </div></li>
                <li><button>Columns</button>
                  <div className='dropdown1'>
                    <ul>
                      <li><button>Insert one column above</button></li>
                      <li><button>Insert one column below</button></li>
                    </ul>
                  </div></li>
              </ul>
            </div></li>
          <li><button>Format</button>
            <div className='dropdown'>
              <ul>
            ...
            <li><button>Collaborators</button>
            <div className='dropdown'>
              <ul>
                <li><button>Add collaborators</button></li>
                <li><button>Remove collaborators</button></li>
              </ul>
            </div></li>
        </ul>
      </div>
